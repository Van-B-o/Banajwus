...
if _G.Hiru_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		game:GetService("CoreGui")["Switch Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(222, 22, 39) 
		...
		game:GetService("CoreGui")["Switch Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(222, 22, 39) 
		...
		game:GetService("CoreGui")["Switch Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(222, 22, 39) 
